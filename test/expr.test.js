...
describe('expr', () => {
    ...
    test('mini-config', () => {
        ...
        const j0 = jsonic_1.Jsonic.make().use(expr_1.Expr, {
            op: {
                // plain: null,
                func: {
                    paren: true,
            ...
            evaluate: (r, _ctx, op, terms) => {
                ...
                // r.n.expr_paren
                'func-paren' === op.name
                    && !((_b = (_a = r.parent.prev) === null || _a === void 0 ? void 0 : _a.u) === null || _b === void 0 ? void 0 : _b.paren_preval)) {
                    terms = ['', ...terms];
                }
                return mf ? mf(...terms) : NaN;
            }
        ...
        // console.log('===========')
        const j1 = jsonic_1.Jsonic.make().use(expr_1.Expr, {
            op: {
                plain: null,
                func: {
                    paren: true,
